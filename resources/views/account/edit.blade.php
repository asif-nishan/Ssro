...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            {{--            @endisset--}}
            <form class="" action="{{route('account.update', $account->id)}}" method="post">
                {{csrf_field()}}
                @method('PUT')
...
{{--                           class="form-control @error('airlines') is-invalid @enderror">--}}
                ...
                <div class="position-relative form-group">
                    ...
                    <input name="current_balance" id="current_balance" placeholder="" type="number" value="{{ $account->current_balance }}"
                ...
                <div class="position-relative form-group">
                    ...
                    <input name="monthly_payment" id="monthly_payment" placeholder="" type="number" value="{{ $account->monthly_payment }}"
                ...
                <div class="position-relative form-group">
                    ...
                    <input name="purchase_price" id="purchase_price" placeholder="" type="number" value="{{ $account->purchase_price }}"
                ...
                <div class="position-relative form-group">
                    ...
                    <input name="profit_from_sell" id="profit_from_sell" placeholder="" type="number" value="{{ $account->profit_from_sell }}"
                ...
                <div class="position-relative form-group">
                    ...
                    <input name="bonus_amount" id="bonus_amount" placeholder="" type="number" value="{{ $account->bonus_amount }}"
                ...
                <div class="position-relative form-group">
                    ...
                    <input name="rest_amount_of_current_month" id="rest_amount_of_current_month" placeholder="" type="number" value="{{ $account->rest_amount_of_current_month }}"
