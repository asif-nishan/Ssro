...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body">
            ...
            @endisset
            <form class="" action="{{route('account-heads.update',$accountHead->id)}}" method="post">
                {{csrf_field()}}
                @method('put')
                <div class="position-relative form-group">
                    <label for="code" class="">Code</label>
                    <input name="code" id="code" placeholder="" type="text"
                           value="{{ old( 'code', $accountHead->code) }}"
                ...
                <div class="position-relative form-group">
                    ...
                    <input name="name" id="name" placeholder="" type="text" value="{{ old('name',$accountHead->name) }}"
                ...
                <div class="position-relative form-group">
                    ...
                    <input name="type" id="type" placeholder="" type="text" value="{{ old('type',$accountHead->type) }}"
